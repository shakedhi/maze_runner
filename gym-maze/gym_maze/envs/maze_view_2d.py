...
class MazeView2D:
    ...
    def __cover_walls(self, x, y, dirs, colour=(0, 0, 255, 15)):
        ...
        for dir in dirs:
            ...
            pygame.draw.line(self.maze_layer, colour, line_head, line_tail, 1)
    ...
    def __draw_entrance(self, colour=(0, 0, 150), transparency=150):

        self.__colour_cell(self.entrance, colour=colour, transparency=transparency)

    def __draw_goal(self, colour=(150, 0, 0), transparency=150):
    ...
    def __colour_cell(self, cell, colour, transparency):
        ...
        x = int(cell[0] * self.CELL_W + 3)
        y = int(cell[1] * self.CELL_H + 3)
        w = int(self.CELL_W - 5)
        h = int(self.CELL_H - 5)
